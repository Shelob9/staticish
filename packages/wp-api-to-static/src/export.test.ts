import {postsToStatic,wpToStatic} from './';
...
describe.skip( 'Generate sites', () => {
    ...
    test.skip( 'JoshPress', () => {
        wpToStatic(
            ...
            Promise.all([
                ...[
                    copy(`${pageDir}/contact.md`,__dirname + '/content/posts/pages/contact.md'),
                    copy(`${pageDir}/contact.md`,__dirname + '/content/posts/pages/josh.md'),
                    copy(`${pageDir}/contact.md`,__dirname + '/content/posts/pages/rest-api.md'),
                    copy(`${pageDir}/contact.md`,__dirname + '/content/posts/pages/gutenberg.md'),
                    copy(`${pageDir}/contact.md`,__dirname + '/content/posts/pages/writing.md'),
                ],
                ...fs.readdirSync(postDir).forEach((fileName: string) => {
                    copy(`${postDir}/${fileName}`,__dirname + '/content/posts/' + fileName )
                })
            ]
            ).then( () => {
